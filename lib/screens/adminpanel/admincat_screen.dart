...
import 'package:shop_app/screens/adminpanel/admincategory_screen.dart';

import '../mydrawer.dart';

class AdminCat_Screen extends StatelessWidget { List<String> _categories = [
  "Summer",
  "Winter",
  "Bags",
  "Shoes",
        ...
        children: [
          Container(
            ...
            child: GridView.builder(
              ...
              return InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => AdminCategory_Screen(_categories[index]),));
                },
                child: Card(
          ...
          Transform.translate(
            ...
            child: InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => AdminCategory_Screen(_categories[4]),));
